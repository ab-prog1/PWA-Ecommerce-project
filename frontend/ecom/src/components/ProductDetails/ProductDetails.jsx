...
class ProductDetails extends Component {
    ...
    render() {
        ...
        // Ensure that productList and productDetails arrays exist and are not empty
        if (!ProductAllData || !ProductAllData.productList || !ProductAllData.productList[0] || !ProductAllData.productDetails || !ProductAllData.productDetails[0]) {
        ...
        if (color !== "na") {
            ...
            var ColorOption = ColorArray.map((ColorList, i) => {
                return <option value={ColorList} key={i}> {ColorList} </option>;
            });
            ColorDiv = "";
        }
        ...
        if (size !== "na") {
            ...
            var SizeOption = SizeArray.map((SizeList, i) => {
                return <option value={SizeList} key={i}> {SizeList} </option>;
            });
            SizeDiv = "";
        }
